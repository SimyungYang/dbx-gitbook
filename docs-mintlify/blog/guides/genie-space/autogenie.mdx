...
> **소스 코드**: [GitHub — AutoGenie](https://github.com/databricks-solutions/autogenie) (Databricks Solutions)

<Card title="AutoGenie 소개 자료 (PDF)" icon="file-pdf" href="/assets/pdf/autogenie-overview.pdf">
