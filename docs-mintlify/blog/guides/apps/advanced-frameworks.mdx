---
title: "AppKit과 Node.js 앱 프레임워크"
description: "AppKit(React + TypeScript) 프레임워크와 Node.js/React 수동 구성 방법, 참고 자료"
---

> 이 문서는 **[고급 기능 (Scale to Zero, Lakebase, DABs, AppKit)](/blog/guides/apps/advanced)** 의 하위 문서입니다.
