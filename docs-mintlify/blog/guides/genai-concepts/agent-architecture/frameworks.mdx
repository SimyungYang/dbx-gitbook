...
> **참고**
이 페이지는 Agent 아키텍처 관점에서의 프레임워크 비교 요약입니다. 각 프레임워크의 상세 코드 예시, 설계 철학, 선택 가이드는 **[Agent 프레임워크 생태계](/blog/guides/genai-concepts/agent-frameworks-detail/overview)** 에서 다룹니다.
