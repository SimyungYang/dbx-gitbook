...
> **참고**
Agent Bricks의 기본 개념(유형 소개, 생성 방법, 활용 시나리오)은 **[교육자료 → AI 에이전트 → Agent Bricks](/training/10-agent-development/agent-bricks)** 를 참고하세요. 이 가이드는 실전 구성, 평가 전략, 베스트 프랙티스에 집중합니다.
