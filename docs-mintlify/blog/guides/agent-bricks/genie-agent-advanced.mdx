---
title: "Agent Bricks에서의 활용: Super과 제한사항과 해결 방법"
---
...
| **쿼리 타임아웃** | 300초 | 비용이 높은 SQL의 무한 실행 방지 |

> **참고**
**Genie의 쿼리 최적화 팁**: Genie가 생성한 SQL이 비용이 높은이라면, Monitoring 탭에서 해당 쿼리를 확인하고, 더 효율적인 SQL을 **Instructions의 예시 쿼리** 로 등록하세요. 유사한 질문에 대해 Genie가 최적화된 SQL 패턴을 학습합니다.
