...
<Info>
Delta Lake의 기본 개념과 트랜잭션 로그 구조는 [GenAI 도구 가이드](/blog/guides/genai-tools)를 참고하세요.
Unity Catalog에서의 테이블 관리와 권한 설정은 [플랫폼 설정 가이드](/blog/guides/platform-setup)를 참고하세요.
</Info>
