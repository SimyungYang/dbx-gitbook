...
```
gold.daily_viewing_summary, gold.device_health_score, gold.streaming_qoe 테이블을 활용하여 "Smart TV Operations Dashboard"를 만들어줘.
...
Row 4 — 운영 지표 (3개):
10. 건강 등급별 크래시/OOM 발생 건수 (Stacked Bar)
...
<Frame>
  <img src="/workshop/section-4-smart-tv-handson/images/Dashboard_1_1_Genie_Done.png" alt="Operations Dashboard - Genie Code로 생성 완료" />
</Frame>

<Frame>
  <img src="/workshop/section-4-smart-tv-handson/images/Dashboard_1_2_Main.png" alt="Operations Dashboard - 메인 뷰 상단" />
</Frame>

<Frame>
  <img src="/workshop/section-4-smart-tv-handson/images/Dashboard_1_3_Main.png" alt="Operations Dashboard - 메인 뷰 하단" />
</Frame>
...
<Frame>
  <img src="/workshop/section-4-smart-tv-handson/images/Dashboard_2_1_Main.png" alt="Ad Performance Dashboard - 상단" />
</Frame>

<Frame>
  <img src="/workshop/section-4-smart-tv-handson/images/Dashboard_2_2_Main.png" alt="Ad Performance Dashboard - 하단" />
</Frame>
...
```
gold.content_popularity, gold.daily_viewing_summary, gold.user_engagement_360을 활용하여 "Content & Engagement Dashboard"를 만들어줘.
...
<Frame>
  <img src="/workshop/section-4-smart-tv-handson/images/Dashboard_3_1_Main.png" alt="Content & Engagement Dashboard - 상단" />
</Frame>

<Frame>
  <img src="/workshop/section-4-smart-tv-handson/images/Dashboard_3_2_Main.png" alt="Content & Engagement Dashboard - 하단" />
</Frame>
...
<Frame>
  <img src="/workshop/section-4-smart-tv-handson/images/GenieSpace_1_1.png" alt="Genie Space 시청 분석 - 생성 완료" />
</Frame>

<Frame>
  <img src="/workshop/section-4-smart-tv-handson/images/GenieSpace_1_2.png" alt="Genie Space 시청 분석 - 테이블 설정" />
</Frame>
...
<Frame>
  <img src="/workshop/section-4-smart-tv-handson/images/GenieSpace_2.png" alt="Genie Space 광고 성과 분석" />
</Frame>
...
<Frame>
  <img src="/workshop/section-4-smart-tv-handson/images/GenieSpace_3.png" alt="Genie Space 디바이스 운영 분석" />
</Frame>

### Genie Space 설정 UI 가이드

Genie Space를 UI에서 직접 설정할 때의 화면입니다.

<Frame>
  <img src="/workshop/section-4-smart-tv-handson/images/Configure_1.png" alt="Genie Space 설정 - 기본 정보" />
</Frame>

<Frame>
  <img src="/workshop/section-4-smart-tv-handson/images/Configure_2.png" alt="Genie Space 설정 - 테이블 선택" />
</Frame>

<Frame>
  <img src="/workshop/section-4-smart-tv-handson/images/Configure_3.png" alt="Genie Space 설정 - General Instructions" />
</Frame>

<Frame>
  <img src="/workshop/section-4-smart-tv-handson/images/Configure_4.png" alt="Genie Space 설정 - 샘플 질문" />
</Frame>

### Genie Space 질의 예시

<Frame>
  <img src="/workshop/section-4-smart-tv-handson/images/GenieSpace_Example_Query_1.png" alt="Genie Space 질의 예시 1" />
</Frame>

<Frame>
  <img src="/workshop/section-4-smart-tv-handson/images/GenieSpace_Example_Query_2.png" alt="Genie Space 질의 예시 2" />
</Frame>

<Frame>
  <img src="/workshop/section-4-smart-tv-handson/images/GenieSpace_Example_Query_3_Step4.png" alt="Genie Space 질의 예시 3 - Step 4" />
</Frame>
...
아래는 Genie Code가 고도화 작업을 순차적으로 수행하는 과정입니다:

<Frame>
  <img src="/workshop/section-4-smart-tv-handson/images/GenieCode_Inside_Chain_1.png" alt="Genie Code Chain 1 - 테이블 분석 시작" />
</Frame>

<Frame>
  <img src="/workshop/section-4-smart-tv-handson/images/GenieCode_Inside_Chain_2.png" alt="Genie Code Chain 2 - 컬럼 분석" />
</Frame>

<Frame>
  <img src="/workshop/section-4-smart-tv-handson/images/GenieCode_Inside_Chain_3_result.png" alt="Genie Code Chain 3 - COMMENT 적용 결과" />
</Frame>

<Frame>
  <img src="/workshop/section-4-smart-tv-handson/images/GenieCode_Inside_Chain_4_result.png" alt="Genie Code Chain 4 - 샘플 질문 등록" />
</Frame>

<Frame>
  <img src="/workshop/section-4-smart-tv-handson/images/GenieCode_Inside_Chain_5_result.png" alt="Genie Code Chain 5 - Instructions 설정" />
</Frame>

<Frame>
  <img src="/workshop/section-4-smart-tv-handson/images/GenieCode_Inside_Chain_6_result.png" alt="Genie Code Chain 6 - 정확도 검증" />
</Frame>
...
모든 Gold 테이블(daily_viewing_summary, content_popularity, ad_campaign_kpi, device_health_score, streaming_qoe, user_engagement_360)의 모든 컬럼에 COMMENT를 달아줘.
```

<Frame>
  <img src="/workshop/section-4-smart-tv-handson/images/genie_table_comments.png" alt="Table COMMENT가 적용된 모습" />
</Frame>
...
> **참고**: `ad_campaign_kpi`에는 시간대(hour) 컬럼이 없으므로, `silver.ad_funnel`의 timestamp를 직접 사용하여 프라임타임 분석을 수행합니다.

```sql
-- silver.ad_funnel의 timestamp로 시간대별 광고 성과 비교
SELECT
  CASE WHEN HOUR(timestamp) BETWEEN 20 AND 23 THEN '프라임타임 (20~23시)' ELSE '비프라임타임' END AS time_slot,
  ...
  ROUND(AVG(bid_price_usd), 2) AS avg_bid_price
FROM smart_tv.silver.ad_funnel
WHERE event_date >= CURRENT_DATE - INTERVAL 7 DAYS
GROUP BY CASE WHEN HOUR(timestamp) BETWEEN 20 AND 23 THEN '프라임타임 (20~23시)' ELSE '비프라임타임' END
```
...
> 💡 **화면 참고**: Genie Space Configure 화면 — 6개 탭
...
> 💡 **화면 참고**: SQL Expressions → Filter/Measure/Dimension 추가 화면
...
> 💡 **화면 참고**: Example query 등록 화면 — Question + SQL answer 입력
...
<Steps>
  <Step title="질문 테스트">
    Genie Space에 다양한 질문을 입력하여 테스트합니다.
  </Step>
  <Step title="SQL 검토">
    Genie가 생성한 SQL이 올바른지 검토합니다.
  </Step>
  <Step title="결과 검증">
    SQL 실행 결과가 비즈니스적으로 합리적인지 검증합니다.
  </Step>
  <Step title="문제 진단">
    결과가 기대와 다른 경우 원인을 분석합니다.
  </Step>
  <Step title="개선 적용">
    진단 결과에 따라 개선합니다: 컬럼 COMMENT 보강, 샘플 질문 추가, General Instructions 수정, 테이블 구조 개선.
  </Step>
  <Step title="재테스트">
    개선 사항이 반영되었는지 다시 질문을 테스트합니다. 정확도가 목표에 도달할 때까지 반복합니다.
  </Step>
</Steps>
...
> **주의**: App 배포 시 서비스 프린시펄에 카탈로그 사용 권한(GRANT)을 부여해야 합니다. [Section 3 Genie Code AI Dev Kit 구성](../section-3-ai-tools-setup/genie-code-aidevkit#step-5-서비스-프린시펄-권한-부여)의 권한 설정을 참고하세요.

<Frame>
  <img src="/workshop/section-4-smart-tv-handson/images/GenieSpace_to_App.png" alt="Genie Space를 Databricks App으로 배포" />
</Frame>
