...
| 케이스 | 대상 제품 | 데이터 | 섹션 |
|--------|----------|--------|------|
| **Smart TV** | webOS Smart TV | 텔레메트리 로그 17테이블 250만건 | [Section 4](section-4-smart-tv-handson/01-setup) |
| **가전 IoT** | 공기청정기(PuriCare) + 에어컨(DUALCOOL) | IoT 센서 로그 17테이블 220만건 | [Section 5](section-5-appliance-handson/01-setup) |

> 환경 구성(Section 1~3) 이후, 소속 조직에 맞는 케이스를 선택하여 Section 4 또는 Section 5를 진행합니다.
...
| 11:30~11:40 | ☕ | 휴식 | 10분 |
| 11:40~11:45 | **핸즈온-01** | 환경 설정 (카탈로그/스키마) | 5분 |
| 11:45~12:00 | **핸즈온-02** | 가상 데이터 생성 | 15분 |
| 12:00~12:30 | **핸즈온-03** | SDP 파이프라인 — 데이터 품질 + 증분 처리 (전반) | 30분 |
| 12:30~13:30 | 🍚 | 점심 | 1시간 |
| 13:30~14:00 | **핸즈온-03** | SDP 파이프라인 (후반) | 30분 |
| 14:00~15:30 | **핸즈온-04** | AI/BI 대시보드 & Genie Space + 정확도 고도화 | 1.5시간 |
| 15:30~15:40 | ☕ | 휴식 | 10분 |
| 15:40~17:40 | **핸즈온-05** | GenAI 에이전트 개발 (KA + Genie + Supervisor) | 2시간 |
