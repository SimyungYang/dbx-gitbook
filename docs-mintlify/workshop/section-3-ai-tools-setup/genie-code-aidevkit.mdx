...
5. 카탈로그 GRANT SQL 출력 (다음 Step에서 실행)
...
Settings → mcp-ai-dev-kit에서 아래 15개만 ON, 나머지는 OFF:
...
| **MCP (AI Dev Kit)** | 크로스 프로덕트 작업 44개 도구 | `./deploy.sh` 한 줄 |
