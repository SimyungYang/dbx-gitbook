...
6. 드롭다운에서 **`mcp-ai-dev-kit`** 선택 → **Save**

> `mcp-ai-dev-kit`이 안 보이면: 앱 상태가 RUNNING인지 확인 (`databricks apps get mcp-ai-dev-kit`)

---

## Step 4: 도구 20개 제한 — 필요한 것만 켜기
...
| **MCP (AI Dev Kit)** | 크로스 프로덕트 작업 44개 도구 | `./deploy.sh` 한 줄 또는 수동 구성 |
