...
│   ├── [IoT] ac_thinq_commands               60,000건   — 제조사 모바일 앱 원격 제어 명령
...
- thinq_registered: BOOLEAN — 제조사 모바일 앱 등록 여부 (75% true)
...
- app_version: STRING — 제조사 모바일 앱 버전
- event_date: DATE

성공률 90%, 실패 6%, 타임아웃 2.5%, 오프라인 1.5%.
COMMENT: '제조사 모바일 앱 에어컨 원격 제어 명령 로그'
Delta 형식, event_date 파티셔닝.
```
...
- error_code: STRING — 'CH01'~'CH15' 에러 코드 체계
