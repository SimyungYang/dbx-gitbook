...
> 💡 **화면 참고**: Settings → MCP Servers → Managed MCP 섹션
...
> 💡 **화면 참고**: Settings → Skills 탭 — 활성화된 Skills 목록
...
> 💡 **화면 참고**: Workspace 파일 브라우저에서 `.assistant/skills/` 디렉토리 구조
...
> 💡 **화면 참고**: 결과 테이블 상단 Filter 아이콘 → 자연어 입력 → 필터링된 결과
...
> 💡 **화면 참고**: 에러 셀 하단의 "Diagnose Error" + "Quick Fix" 버튼
> 💡 **화면 참고**: Quick Fix 제안 — "Accept and run" 버튼
