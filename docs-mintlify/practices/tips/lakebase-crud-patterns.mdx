...
<Info>
Databricks Apps의 기본 구조와 배포 방법은 [Apps 가이드 — 앱 만들기](/practices/apps/create-app)를 먼저 참고하세요.
Lakebase 리소스 연결과 Service Principal 권한은 [Apps 리소스 관리](/practices/apps/resources)에서 다룹니다.
</Info>
