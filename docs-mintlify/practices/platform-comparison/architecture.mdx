...
> 이 문서는 **[플랫폼 비교](/practices/platform-comparison/overview)** 섹션의 일부입니다.
...
| **플랫폼 의존 리스크** | 최소 (오픈 포맷 + 고객 소유 스토리지) | 높음 (독점 포맷, 이관 시 COPY 필요) | 중간 (AWS 종속) | 중간-높음 (GCP 종속 + 독점 포맷) | 중간 (Azure/MS 생태계 종속) |
