...
![Building a Multi-Agent System with OpenAI Agents SDK on Databricks](https://miro.medium.com/v2/resize:fit:1100/format:webp/0*U8Hkj9qip7Fv2ndi)
...
![Multi-Agent Workflow Example](https://miro.medium.com/v2/resize:fit:1100/format:webp/0*s-I2A7qgygjRL80s)
...
![Tool Calling Example](https://miro.medium.com/v2/resize:fit:1100/format:webp/0*L_0TdMaR9MmzOliM)
...
![Unity Catalog Functions 탭에서 확인할 수 있는 함수 목록](https://miro.medium.com/v2/resize:fit:1100/format:webp/0*yfvyaTCbvGKM0MsU)
...
![멀티 에이전트 시스템의 그래프 표현](https://miro.medium.com/v2/resize:fit:1100/format:webp/0*nsZQzC5jNfXv7WvE)
...
![채팅 로그: 첫 번째 질문과 응답](https://miro.medium.com/v2/resize:fit:1100/format:webp/0*n7pwO-7-GAc5dGXV)

![채팅 로그: 두 번째 질문과 응답](https://miro.medium.com/v2/resize:fit:1100/format:webp/0*PbegCbGuW3kMHmtK)
...
![노트북 내 MLflow 트레이싱 UI](https://miro.medium.com/v2/resize:fit:1100/format:webp/0*U8dV5Dd5QnAI8krw)

![첫 번째 에이전트 워크플로우의 종료 지점](https://miro.medium.com/v2/resize:fit:1100/format:webp/0*8YuqWqxK3hZweHlJ)

![에이전트에 의한 성공적인 도구 실행](https://miro.medium.com/v2/resize:fit:1100/format:webp/0*WDcVVqTMrRaDsci7)
...
![기록된 에이전트 코드](https://miro.medium.com/v2/resize:fit:1100/format:webp/0*T8SDbxKUCbfq7Bd3)
...
![AI Playground에서 에이전트 테스트](https://miro.medium.com/v2/resize:fit:1100/format:webp/0*_wSXoTzVNd_A602k)

![Review App에서 에이전트 테스트](https://miro.medium.com/v2/resize:fit:1100/format:webp/0*AZiWfKuWyoDfamS8)
