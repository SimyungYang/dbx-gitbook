...
## Lakeflow Connect: 간편하고 확장 가능한 데이터 수집
...
## 데이터 엔지니어링의 미래는 단순하고, 통합되고, 지능적입니다

Lakeflow는 고객이 더 신선하고, 더 완전하고, 더 높은 품질의 데이터를 비즈니스에 전달할 수 있게 해줄 것입니다. Lakeflow는 **Lakeflow Connect** 를 시작으로 곧 프리뷰 (Preview) 를 시작할 예정입니다. 접근 권한을 요청하려면 [여기에서 등록](https://www.databricks.com/blog/introducing-databricks-lakeflow)하세요. 앞으로 몇 달에 걸쳐 추가 기능이 제공될 예정이니 Lakeflow의 새로운 발표를 기대해 주세요.

---

## 직접 체험해 보세요

[Lakeflow 제품 투어](https://www.databricks.com/blog/introducing-databricks-lakeflow)를 통해 여러 소스에서 배치 및 실시간으로 데이터를 원활하게 수집, 변환, 프로덕션 배포하는 과정을 직접 확인해 보세요.
