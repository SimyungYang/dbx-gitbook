...
> **원문**: [Building a near real-time application with Zerobus Ingest and Lakebase](https://www.databricks.com/blog/building-near-real-time-application-zerobus-ingest-and-lakebase) (2026-03-06)

작성자: Grant Doyle, Benjamin Nwokeleme

---

**요약**

- Zerobus Ingest는 IoT, 클릭스트림, 텔레메트리 사용 사례에서 멀티 홉(multi-hop) 아키텍처를 제거합니다
- Lakebase는 복잡한 커스텀 ETL 파이프라인을 제거하고 운영 사용 사례를 위한 트랜잭션 데이터를 통합합니다
- Zerobus Ingest, Lakebase, Databricks Apps를 사용하여 준실시간 대시보드를 구축합니다
...
![애플리케이션 아키텍처: Data Producer, Zerobus Ingest, Delta, Lakebase, Databricks Apps](https://www.databricks.com/sites/default/files/inline-images/blog-zerobus-lakebase-arch.png?v=1772426984)
...
![Lakebase 인스턴스에 동기화 테이블 생성](https://www.databricks.com/sites/default/files/inline-images/blog-zerobus-lakebase-create-table.png?v=1772426984)
...
![RideShare360 애플리케이션 스크린샷](https://www.databricks.com/sites/default/files/inline-images/blog-zerobus-lakebase-rideshare.png?v=1772426984)
...
- [원문 블로그: Building a near real-time application with Zerobus Ingest and Lakebase](https://www.databricks.com/blog/building-near-real-time-application-zerobus-ingest-and-lakebase)
