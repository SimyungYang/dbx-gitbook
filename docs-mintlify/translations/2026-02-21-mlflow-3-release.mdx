...
> **원문**: [MLflow 3.0: Unified AI Experimentation, Observability, and Governance](https://www.databricks.com/blog/mlflow-30-unified-ai-experimentation-observability-and-governance)
...
이것은 단순한 기능 업데이트가 아닙니다. MLflow 3는 오픈 소스 ML 툴링으로 가능한 것을 근본적으로 확장합니다. 그동안 GenAI를 프로덕션에 배포할 때 품질과 관측 가능성(**Observability**)에 대한 확신 없이 감으로 진행해야 했던 문제를 정면으로 해결합니다.
