...
> 💡 **화면 참고**: AI Dev Kit 설치 완료 메시지

---

## 설치 방법 2: Genie Code에서 사용 (Builder App + MCP)

Genie Code에서 AI Dev Kit을 사용하려면 **Builder App을 `--enable-mcp` 옵션으로 배포**합니다.
...
전체 절차는 **[Section 2: AI Builder App 배포 핸즈온](../section-2-ai-builder-app/overview)**에서 단계별로 상세히 안내합니다.
...
| Custom MCP Server 호스팅 | [docs.databricks.com/mcp/custom-mcp](https://docs.databricks.com/aws/en/generative-ai/mcp/custom-mcp) |
| Genie Code + MCP 연결 | [docs.databricks.com/genie-code/mcp](https://docs.databricks.com/aws/en/genie-code/mcp) |
