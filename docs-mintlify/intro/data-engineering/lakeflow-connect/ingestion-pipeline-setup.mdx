...
<CardGroup cols={1}>
  <Card title="수집 파이프라인 구성 — 심화 — 기초" href="ingestion-pipeline-setup-advanced-basics">
    기본 개념과 핵심 기능
  </Card>
  <Card title="수집 파이프라인 구성 — 심화 — 심화" href="ingestion-pipeline-setup-advanced-advanced">
    고급 패턴과 실전 활용
  </Card>
</CardGroup>
