...
> 이 문서는 **[Unity Catalog](/intro/unity-catalog/overview)** 섹션의 일부입니다.
...
External Location이 올바르게 설정되었는지 검증할 수 있습니다.

```sql
-- External Location 연결 테스트
...
| **Storage Credential 연결** | External Location은 반드시 하나의 Storage Credential과 연결됩니다 |
