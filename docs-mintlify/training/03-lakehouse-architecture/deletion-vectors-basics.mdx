---
title: "왜 Deletion Vectors가 필요한가요과 Copy-on-Write"
---
...
> 💡 **Deletion Vectors(Deletion Vector)** 는 이러한 비효율을 해결하기 위해 도입된 기술입니다. 파일을 다시 쓰지 않고, **어떤 행이 삭제되었는지를 별도의 파일에 기록** 하는 방식으로 DELETE, UPDATE, MERGE의 성능을 크게 향상시킵니다.
