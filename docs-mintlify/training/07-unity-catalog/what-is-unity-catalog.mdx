...
![Unity Catalog 객체 모델 — 계층 구조](https://docs.databricks.com/aws/en/assets/images/object-hierarchy-966dee8fa239626134ed6b7278beab2c.png)
...
> **다음 페이지**: 실습(카탈로그/스키마/테이블 생성)과 멀티 리전 UC 통합 전략은 [Unity Catalog 실습과 멀티 리전 전략](/training/07-unity-catalog/what-is-unity-catalog-hands-on) 페이지에서 이어집니다.
