---
title: "Unity Catalog 실습과 멀티 리전 전략"
description: "Unity Catalog에서 카탈로그, 스키마, 테이블을 생성하는 실습과 엔터프라이즈 멀티 리전 통합 전략을 다룹니다."
---

> 이 페이지는 [Unity Catalog란?](/training/07-unity-catalog/what-is-unity-catalog) 의 후속 내용입니다. UC의 개념, 아키텍처, 자산 유형 등 기본 내용은 해당 페이지를 참고하세요.
