...
> 이 문서는 **[Databricks 플랫폼 개요](/training/02-databricks-overview/overview)** 섹션의 일부입니다.
...
> **직접 체험해보세요**: Databricks가 어떤 플랫폼인지 이해했다면, [무료 체험](/training/02-databricks-overview/getting-started-trial)에서 직접 사용해보세요. 14일간 모든 기능을 무료로 체험할 수 있습니다.
