---
title: "서버리스 컴퓨팅 보안, 비용, 마이그레이션"
description: "Databricks 서버리스 컴퓨팅의 보안 고려사항, 비용 모델, 제한사항, 클래식에서 서버리스로의 마이그레이션 가이드를 다룹니다."
---

> 이 페이지는 [Serverless 컴퓨트](/training/04-compute-and-workspace/serverless-compute) 의 후속 내용입니다. 서버리스 개요, 아키텍처, 워크로드별 상세 내용은 해당 페이지를 참고하세요.
