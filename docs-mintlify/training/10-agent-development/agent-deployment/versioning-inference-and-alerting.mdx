---
title: "Inference Table, 알림, 운영 워크플로"
description: "Inference Table을 활용한 자동 로깅, Lakehouse Monitoring 알림, 자동 롤백 파이프라인, 전체 버전 업데이트 워크플로를 다룹니다."
---

> 이 페이지는 [버전 관리와 모니터링](/training/10-agent-development/agent-deployment/versioning-and-monitoring) 의 후속 내용입니다. 버전 관리, 배포 전략, 모니터링 메트릭, MLflow Tracing 내용은 해당 페이지를 참고하세요.
